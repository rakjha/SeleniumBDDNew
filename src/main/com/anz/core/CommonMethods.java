...
public class CommonMethods {
        ...
        if (!webElement.isEmpty()) {
            ...
            for (WebElement element : webElement) {
                if (element.isDisplayed()) {
                    System.out.println("WebElement is displayed" + element.getText());
                    counter++;
                }
            }
            return counter > 0;
    ...
    public static void waitForListOfElementsToBeVisible(List<WebElement> elements, int timeoutInSeconds) {
        WebDriverWait webDriverWait = new WebDriverWait(BaseMethods.WEB_DRIVER_THREAD_LOCAL.get(), Duration.ofSeconds(30));
    ...
    public static void verifyElementsPresent(List<WebElement> element) {
        assertFalse(element.isEmpty(), "List of elements not present");
    }
    ...
    public static void verifyText(String object, String data) {
        assertEquals(object, data, "Actual text is " + object);
    }
    ...
    public static void defaultSelected(WebElement ele, String property) {
        if (ele.getAttribute("class").contains(property)) {
            ...
            assertFalse(false, "Element " + ele + " is default selected");
        }
    }
    ...
    public static void verifyBothElementsEquals(WebElement element1, WebElement element2) {
        assertEquals(element1, element2, "Mismatch of elements");
    }
    ...
    public void typeInTextField(WebElement element, String input) {
        element.clear();
    ...
    public void verifyText(WebElement element, String inputText) {
        assertEquals(element.getText().trim(), inputText.trim());
    }
